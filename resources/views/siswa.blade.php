...
<head>
    ...
    <title>Data Siswa - PX PRSN</title>
...
<body class="flex h-screen bg-slate-50 font-sans text-slate-800 overflow-hidden">
    ...
    <div class="flex-1 flex flex-col p-8 overflow-y-auto">
        <h2 class="text-2xl font-bold text-slate-800 mb-6">Master Data Siswa</h2>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            <td class="py-4 px-6 text-sm font-medium text-slate-900">{{ $siswa->nim }}</td>
                            <td class="py-4 px-6 text-sm text-slate-600">{{ $siswa->nama_lengkap }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
